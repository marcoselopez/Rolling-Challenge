...
const projectTopItem1 = document.styleSheets[3].cssRules[58].style
const projectBottomItem1 = document.styleSheets[3].cssRules[59].style
const projectbox1 = document.querySelector('#projectBox1')
//NOTE PROJECT ITEMS 2
const projectTopItem2 = document.styleSheets[3].cssRules[60].style
const projectBottomItem2 = document.styleSheets[3].cssRules[61].style
const projectbox2 = document.querySelector('#projectBox2')
//NOTE PROJECT ITEMS 3
const projectTopItem3 = document.styleSheets[3].cssRules[62].style
const projectBottomItem3 = document.styleSheets[3].cssRules[63].style
